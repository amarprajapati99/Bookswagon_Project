...
public class CustomListener extends BaseClass implements ITestListener{
    ...
    public void onTestSuccess(ITestResult result) {
        ...
        Log.info(result.getMethod().getMethodName() + " :take success screenshot in interface listener method");
    ...
    public void onTestFailure(ITestResult result) {
        ...
        try {
            ...
            Log.error(result.getMethod().getMethodName() + " :take failed screenshot in interface listener method");
            Allure.addAttachment(result.getName(), new ByteArrayInputStream (((TakesScreenshot) driver).getScreenshotAs(OutputType.BYTES)));
