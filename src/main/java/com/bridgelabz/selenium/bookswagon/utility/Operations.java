...
public class Operations extends BaseClass{
    ...
    public String buy_test() throws InterruptedException, IOException {
        ...
        Thread.sleep(4000);
        Log.info("clearing the quantity size");
        quantity.clear();
        Log.info("updating quantity size");
        quantity.sendKeys("3");
        Thread.sleep(3000);
    ...
    public String remove_from_cart() throws InterruptedException {
        ...
        cart.click();
        Thread.sleep(1000);
        Log.info("switch to cart window");
        driver.switchTo().frame(0);
        Thread.sleep(1000);
        Log.info("remove cart frame");
        remove_from_cart.click();
        Thread.sleep(2000);
        Log.info("successfully book removed from cart");
        return driver.getTitle();
    }
